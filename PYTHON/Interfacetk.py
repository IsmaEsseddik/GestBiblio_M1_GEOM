...
class Exemp():
    ...
    def __init__(self, master):
        ...
        self.cadrecom = tk.Frame(self.cadrelib, bg='#d8d8d8')
        # creation de libellés
        self.welcome_label = tk.Label(self.cadre_entete, text="Gestionnaire d'exemplaire : Ici vous pouvez rechercher un exemplaire dans la base de données", bg='orange')
